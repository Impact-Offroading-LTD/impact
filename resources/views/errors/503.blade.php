      ...
      <div class="container">       
         <div class="card" style="margin: auto;border-radius:25px;">
            <div class="card-body">
                  ...
                  <div class="col-sm-12">
                  <p style="padding:0px;margin:0px;font-size:25px;" class="text-primary"><img class="mb-3" src="/dirtbike.svg" alt="" width="50" style="margin-top:10px;"> <strong>Planned Maintenance</strong></p>
                  <p><strong>Impact is currently unavailable!</strong><br>We are currently unavailable to process your request at the moment, a maintenance is in progress you should try again later. This won't take long often this is a small update or critical bug fix.</p>

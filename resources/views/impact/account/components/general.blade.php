...
<br><br>
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" wire:model="tag" value="{{Auth::user()->tag}}" >
            </div>

            <div class="mb-3">
               <label for="exampleInputEmail1" class="form-label">Email address</label>
               <input type="email" class="form-control" wire:model="email" value="{{Auth::user()->email}}" >
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" wire:model="fav_trail" value="{{Auth::user()->fav_trail}}" >
            </div>

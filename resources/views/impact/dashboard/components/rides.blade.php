        ...
        <div class="modal-content">
            ...
            <!-- Begin Form-->
                <div class="mb-3">
                   ...
                   <input required wire:model.defer="newride_name" type="text" class="form-control">
                </div>

                <div class="mb-3">
                   <label for="exampleInputEmail1" class="form-label">Location</label>
                   <input required wire:model.defer="newride_location" type="text" class="form-control" value="{{Auth::user()->tag}}" >
                </div>

                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Trail</label>
                    <input required wire:model.defer="newride_trail" type="text" class="form-control" value="{{Auth::user()->fav_trail}}" >
                </div>


                <div class="mb-3">
                   <label for="exampleInputEmail1" class="form-label">Ride Type</label>
                   <input required wire:model.defer="newride_type" type="text" class="form-control"value="{{Auth::user()->fav_trail}}" >
                </div>

                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Distance</label>
                    <input wire:model.defer="newride_distance" type="text" class="form-control" value="{{Auth::user()->fav_trail}}" >

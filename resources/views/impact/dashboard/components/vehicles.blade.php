        ...
        <div class="modal-content">
            ...
            <!-- Begin Form-->
                <div class="mb-3">
                   ...
                   <input required wire:model.defer="newveh_name" type="text" class="form-control" >
                </div>

                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Model</label>
                    <input required wire:model.defer="newveh_model" type="text" class="form-control" >
                 </div>

                <div class="mb-3">
                   <label for="exampleInputEmail1" class="form-label">Vehicle Type</label>
                   <input required wire:model.defer="newveh_type" type="text" class="form-control" value="{{Auth::user()->tag}}" >
                </div>

                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Total Milage</label>
                    <input required wire:model.defer="newveh_distance" type="text" class="form-control" value="{{Auth::user()->fav_trail}}" >
                </div>
